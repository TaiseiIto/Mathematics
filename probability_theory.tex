...
ただし，$0\le p\le 1$である．
 ...
 \begin{align}
  M_X\left(t\right)&=E\left(e^{tX}\right)\nonumber\\
  &=e^{t0}\left(1-p\right)+e^{t1}p\nonumber\\
  &=e^0\left(1-p\right)+e^tp\nonumber\\
  &=\left(1-p\right)+e^tp\nonumber\\
  &=pe^t+1-p\\
 ...
 \begin{align}
  H\left(X\right)&=E\left(-\log_2p\left(X\right)\right)\nonumber\\
  &=\left(1-p\right)\left(-\log_2\left(1-p\right)\right)+p\left(-\log_2p\right)\nonumber\\
 ...
 \begin{align}
  \phi_X\left(t\right)&=E\left(e^{itX}\right)\nonumber\\
  &=\left(1-p\right)e^{it0}+pe^{it1}\nonumber\\
  &=\left(1-p\right)+pe^{it}\nonumber\\
  &=pe^{it}+1-p
 \end{align}
...
を二項分布といい，その標本空間は$S=\{0,\cdots,N\}$であり，その確率質量関数は
 \begin{align}
  p\left(n\right)&={}_NC_np^n\left(1-p\right)^{N-n}
 \end{align}
である．
 \subsection{原点周りの積率母関数}
 \begin{align}
  M_X\left(t\right)&=E\left(e^{tX}\right)\nonumber\\
  &=\sum_{n=0}^Ne^{tn}{}_NC_np^n\left(1-p\right)^{N-n}\nonumber\\
  &=\sum_{n=0}^N{}_NC_n\left(pe^t\right)^n\left(1-p\right)^{N-n}\nonumber\\
  &=\left(pe^t+1-p\right)^N\\
  M_X^{\left(1\right)}\left(t\right)&=Npe^t\left(pe^t+1-p\right)^{N-1}\\
  M_X^{\left(2\right)}\left(t\right)&=Npe^t\left(pe^t+1-p\right)^{N-1}+N\left(N-1\right)p^2e^2t\left(pe^t+1-p\right)^{N-2}
 \end{align}
 \subsection{平均}
 \begin{align}
  E\left(X\right)&=M_X^{\left(1\right)}\left(0\right)\nonumber\\
  &=Npe^0\left(pe^0+1-p\right)^{N-1}\nonumber\\
 ...
 \begin{align}
  V\left(X\right)&=E\left(X^2\right)-E\left(X\right)^2\nonumber\\
  &=M_X^{\left(2\right)}\left(0\right)-\left(Np\right)^2\nonumber\\
  &=Npe^0\left(pe^0+1-p\right)^{N-1}+N\left(N-1\right)p^2e^{2\times 0}\left(pe^0+1-p\right)^{N-2}-N^2p^2\nonumber\\
  &=Np\left(p+1-p\right)^{N-1}+N\left(N-1\right)p^2\left(p+1-p\right)^{N-2}-N^2p^2\nonumber\\
  &=Np+N\left(N-1\right)p^2-N^2p^2\nonumber\\
 ...
 \begin{align}
  M_{X-E\left(X\right)}\left(t\right)&=E\left(e^{t\left(X-E\left(X\right)\right)}\right)\nonumber\\
  &=E\left(e^{t\left(X-Np\right)}\right)\nonumber\\
  &=\sum_{n=0}^Ne^{t\left(n-Np\right)}{}_NC_np^n\left(1-p\right)^{N-n}\nonumber\\
  &=\sum_{n=0}^Ne^{nt}e^{-Npt}{}_NC_np^n\left(1-p\right)^{N-n}\nonumber\\
  &=e^{-Npt}\sum_{n=0}^N{}_NC_n\left(pe^t\right)^n\left(1-p\right)^{N-n}\nonumber\\
  &=e^{-Npt}\left(pe^t+1-p\right)^N\\
  M_{X-E\left(X\right)}\left(0\right)&=e^{-Np0}\left(pe^0+1-p\right)^N\nonumber\\
  &=e^0\left(pe^0+1-p\right)^N\nonumber\\
  &=\left(p+1-p\right)^N\nonumber\\
  &=1^N\nonumber\\
  &=1
 \end{align}
 \begin{align}
  M_{X-E\left(X\right)}^{\left(1\right)}\left(t\right)&=\frac{d}{dt}e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &=\left(\frac{d}{dt}e^{-Npt}\right)\left(pe^t+1-p\right)^N+e^{-Npt}\left(\frac{d}{dt}\left(pe^t+1-p\right)^N\right)\nonumber\\
  &=-Npe^{-Npt}\left(pe^t+1-p\right)^N+e^{-Npt}N\left(pe^t+1-p\right)^{N-1}\frac{d}{dt}\left(pe^t+1-p\right)\nonumber\\
  &=-Npe^{-Npt}\left(pe^t+1-p\right)^N+e^{-Npt}N\left(pe^t+1-p\right)^{N-1}pe^t\nonumber\\
  &=-Npe^{-Npt}\left(pe^t+1-p\right)^N+Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &=Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}-Npe^{-Npt}\left(pe^t+1-p\right)^N\\
  M_{X-E\left(X\right)}^{\left(1\right)}\left(0\right)&=Npe^{\left(1-Np\right)0}\left(pe^0+1-p\right)^{N-1}-Npe^{-Np0}\left(pe^0+1-p\right)^N\nonumber\\
  &=Npe^0\left(pe^0+1-p\right)^{N-1}-Npe^0\left(pe^0+1-p\right)^N\nonumber\\
  &=Np\left(p+1-p\right)^{N-1}-Np\left(p+1-p\right)^N\nonumber\\
  &=Np1^{N-1}-Np1^N\nonumber\\
  &=Np1-Np1\nonumber\\
  &=Np-Np\nonumber\\
  &=0
 \end{align}
 \begin{align}
  M_{X-E\left(X\right)}^{\left(2\right)}\left(t\right)&=\frac{d}{dt}\left(Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}-Npe^{-Npt}\left(pe^t+1-p\right)^N\right)\nonumber\\
  &=Np\frac{d}{dt}e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}-Np\frac{d}{dt}e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &=Np\left(\left(\frac{d}{dt}e^{\left(1-Np\right)t}\right)\left(pe^t+1-p\right)^{N-1}+e^{\left(1-Np\right)t}\left(\frac{d}{dt}\left(pe^t+1-p\right)^{N-1}\right)\right)\nonumber\\
  &\quad-Np\left(Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}-Npe^{-Npt}\left(pe^t+1-p\right)^N\right)\nonumber\\
  &=Np\left(\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+e^{\left(1-Np\right)t}\left(N-1\right)\left(pe^t+1-p\right)^{N-2}pe^t\right)\nonumber\\
  &\quad-Np\left(Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}-Npe^{-Npt}\left(pe^t+1-p\right)^N\right)\nonumber\\
  &=Np\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+Np^2\left(N-1\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad-N^2p^2e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+N^2p^2e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &=N^2p^2e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad-N^2p^2e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+\left(Np\left(1-Np\right)-N^2p^2\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+\left(Np-N^2p^2-N^2p^2\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+\left(Np-2N^2p^2\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(1-2Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}
 \end{align}
 \begin{align}
  M_{X-E\left(X\right)}^{\left(2\right)}\left(0\right)&=N^2p^2e^{-Np0}\left(pe^0+1-p\right)^N\nonumber\\
  &\quad+Np\left(1-2Np\right)e^{\left(1-Np\right)0}\left(pe^0+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^{\left(2-Np\right)0}\left(pe^0+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2e^0\left(pe^0+1-p\right)^N\nonumber\\
  &\quad+Np\left(1-2Np\right)e^0\left(pe^0+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)e^0\left(pe^0+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2\left(p+1-p\right)^N\nonumber\\
  &\quad+Np\left(1-2Np\right)\left(p+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(p+1-p\right)^{N-2}\nonumber\\
  &=N^2p^21^N\nonumber\\
  &\quad+Np\left(1-2Np\right)1^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)1^{N-2}\nonumber\\
  &=N^2p^2+Np\left(1-2Np\right)+Np^2\left(N-1\right)\nonumber\\
  &=Np\left(Np+1-2Np+Np-p\right)\nonumber\\
  &=Np\left(1-p\right)\nonumber\\
 \end{align}
 \begin{align}
  M_{X-E\left(X\right)}^{\left(3\right)}\left(t\right)&=N^2p^2\frac{d}{dt}e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(1-2Np\right)\frac{d}{dt}e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)\frac{d}{dt}e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &=N^2p^2\left(\left(\frac{d}{dt}e^{-Npt}\right)\left(pe^t+1-p\right)^N+e^{-Npt}\frac{d}{dt}\left(pe^t+1-p\right)^N\right)\nonumber\\
  &\quad+Np\left(1-2Np\right)\left(\left(\frac{d}{dt}e^{\left(1-Np\right)t}\right)\left(pe^t+1-p\right)^{N-1}+e^{\left(1-Np\right)t}\frac{d}{dt}\left(pe^t+1-p\right)^{N-1}\right)\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(\left(\frac{d}{dt}e^{\left(2-Np\right)t}\right)\left(pe^t+1-p\right)^{N-2}+e^{\left(2-Np\right)t}\frac{d}{dt}\left(pe^t+1-p\right)^{N-2}\right)\nonumber\\
  &=N^2p^2\left(-Npe^{-Npt}\left(pe^t+1-p\right)^N+e^{-Npt}N\left(pe^t+1-p\right)^{N-1}pe^t\right)\nonumber\\
  &\quad+Np\left(1-2Np\right)\left(\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+e^{\left(1-Np\right)t}\left(N-1\right)\left(pe^t+1-p\right)^{N-2}pe^t\right)\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(\left(2-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}+e^{\left(2-Np\right)t}\left(N-2\right)\left(pe^t+1-p\right)^{N-3}pe^t\right)\nonumber\\
  &=N^2p^2\left(-Npe^{-Npt}\left(pe^t+1-p\right)^N+Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\right)\nonumber\\
  &\quad+Np\left(1-2Np\right)\left(\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+\left(N-1\right)pe^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\right)\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(\left(2-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}+\left(N-2\right)pe^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\right)\nonumber\\
  &=-N^3p^3e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+N^3p^3e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np\left(1-2Np\right)\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np\left(1-2Np\right)\left(N-1\right)pe^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(2-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^3e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+\left(N^3p^3+Np\left(1-2Np\right)\left(1-Np\right)\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+\left(Np\left(1-2Np\right)\left(N-1\right)p+Np^2\left(N-1\right)\left(2-Np\right)\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^3e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(N^2p^2+\left(1-2Np\right)\left(1-Np\right)\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(\left(1-2Np\right)\left(N-1\right)+\left(N-1\right)\left(2-Np\right)\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^3e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
 \end{align}
 \begin{align}
  M_{X-E\left(X\right)}^{\left(3\right)}\left(0\right)&=-N^3p^3e^{-Np0}\left(pe^0+1-p\right)^N\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)e^{\left(1-Np\right)0}\left(pe^0+1-p\right)^{N-1}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)e^{\left(2-Np\right)0}\left(pe^0+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)e^{\left(3-Np\right)0}\left(pe^0+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^3e^0\left(pe^0+1-p\right)^N\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)e^0\left(pe^0+1-p\right)^{N-1}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)e^0\left(pe^0+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)e^0\left(pe^0+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^3\left(p+1-p\right)^N\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\left(p+1-p\right)^{N-1}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\left(p+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(p+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^31^N\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)1^{N-1}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)1^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)1^{N-3}\nonumber\\
  &=-N^3p^3\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\nonumber\\
  &=Np\left(-N^2p^2+\left(3N^2p^2-3Np+1\right)+3p\left(N-1\right)\left(1-Np\right)+p^2\left(N-1\right)\left(N-2\right)\right)\nonumber\\
  &=Np\left(-N^2p^2+\left(3N^2p^2-3Np+1\right)+\left(3Np-3N^2p^2-3p+3Np^2\right)+\left(N^2p^2-3Np^2+2p^2\right)\right)\nonumber\\
  &=Np\left(2p^2-3p+1\right)\nonumber\\
  &=Np\left(1-p\right)\left(1-2p\right)
 \end{align}
どこかで計算ミスが起きている可能性が高い．
 \begin{align}
  M_{X-E\left(X\right)}^{\left(4\right)}\left(t\right)&=-N^3p^3\frac{d}{dt}e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\frac{d}{dt}e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\frac{d}{dt}e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\frac{d}{dt}e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &=-N^3p^3\left(\left(\frac{d}{dt}e^{-Npt}\right)\left(pe^t+1-p\right)^N+e^{-Npt}\frac{d}{dt}\left(pe^t+1-p\right)^N\right)\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\left(\left(\frac{d}{dt}e^{\left(1-Np\right)t}\right)\left(pe^t+1-p\right)^{N-1}+e^{\left(1-Np\right)t}\frac{d}{dt}\left(pe^t+1-p\right)^{N-1}\right)\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\left(\left(\frac{d}{dt}e^{\left(2-Np\right)t}\right)\left(pe^t+1-p\right)^{N-2}+e^{\left(2-Np\right)t}\frac{d}{dt}\left(pe^t+1-p\right)^{N-2}\right)\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(\left(\frac{d}{dt}e^{\left(3-Np\right)t}\right)\left(pe^t+1-p\right)^{N-3}+e^{\left(3-Np\right)t}\frac{d}{dt}\left(pe^t+1-p\right)^{N-3}\right)\nonumber\\
  &=-N^3p^3\left(-Npe^{-Npt}\left(pe^t+1-p\right)^N+e^{-Npt}N\left(pe^t+1-p\right)^{N-1}pe^t\right)\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\left(\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+e^{\left(1-Np\right)t}\left(N-1\right)\left(pe^t+1-p\right)^{N-2}pe^t\right)\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\left(\left(2-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}+e^{\left(2-Np\right)t}\left(N-2\right)\left(pe^t+1-p\right)^{N-3}pe^t\right)\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(\left(3-Np\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}+e^{\left(3-Np\right)t}\left(N-3\right)\left(pe^t+1-p\right)^{N-4}pe^t\right)\nonumber\\
  &=-N^3p^3\left(-Npe^{-Npt}\left(pe^t+1-p\right)^N+Npe^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\right)\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\left(\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}+\left(N-1\right)pe^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\right)\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\left(\left(2-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}+\left(N-2\right)pe^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\right)\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(\left(3-Np\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}+\left(N-3\right)pe^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\right)\nonumber\\
  &=N^4p^4e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad-N^4p^4e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\left(1-Np\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np\left(3N^2p^2-3Np+1\right)\left(N-1\right)pe^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\left(2-Np\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+3Np^2\left(N-1\right)\left(1-Np\right)\left(N-2\right)pe^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(3-Np\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(N-3\right)pe^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\nonumber\\
  &=N^4p^4e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+\left(Np\left(3N^2p^2-3Np+1\right)\left(1-Np\right)-N^4p^4\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+\left(Np\left(3N^2p^2-3Np+1\right)\left(N-1\right)p+3Np^2\left(N-1\right)\left(1-Np\right)\left(2-Np\right)\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+\left(3Np^2\left(N-1\right)\left(1-Np\right)\left(N-2\right)p+Np^3\left(N-1\right)\left(N-2\right)\left(3-Np\right)\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(N-3\right)pe^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\nonumber\\
 \end{align}
 \begin{align}
  &=N^4p^4e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(\left(3N^2p^2-3Np+1\right)\left(1-Np\right)-N^3p^3\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+N\left(N-1\right)p^2\left(\left(3N^2p^2-3Np+1\right)+3\left(1-Np\right)\left(2-Np\right)\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+N\left(N-1\right)\left(N-2\right)p^3\left(3\left(1-Np\right)+\left(3-Np\right)\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(N-3\right)pe^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\nonumber\\
  &=N^4p^4e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(-3N^3p^3+6N^2p^2-4Np+1-N^3p^3\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+N\left(N-1\right)p^2\left(3N^2p^2-3Np+1+3N^2p^2-9Np+6\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+N\left(N-1\right)\left(N-2\right)p^3\left(-4Np+6\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(N-3\right)pe^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\nonumber\\
  &=N^4p^4e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(-4N^3p^3+6N^2p^2-4Np+1\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(6N^2p^2-12Np+7\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(-4Np+6\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^4\left(N-1\right)\left(N-2\right)\left(N-3\right)e^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\nonumber\\
  &=N^4p^4e^{-Npt}\left(pe^t+1-p\right)^N\nonumber\\
  &\quad+Np\left(2Np-1\right)\left(-2N^2p^2+2Np-1\right)e^{\left(1-Np\right)t}\left(pe^t+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(6N^2p^2-12Np+7\right)e^{\left(2-Np\right)t}\left(pe^t+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(-4Np+6\right)e^{\left(3-Np\right)t}\left(pe^t+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^4\left(N-1\right)\left(N-2\right)\left(N-3\right)e^{\left(4-Np\right)t}\left(pe^t+1-p\right)^{N-4}\nonumber\\
 \end{align}
 \begin{align}
  M_{X-E\left(X\right)}^{\left(4\right)}\left(0\right)&=N^4p^4e^{-Np0}\left(pe^0+1-p\right)^N\nonumber\\
  &\quad+Np\left(2Np-1\right)\left(-2N^2p^2+2Np-1\right)e^{\left(1-Np\right)0}\left(pe^0+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(6N^2p^2-12Np+7\right)e^{\left(2-Np\right)0}\left(pe^0+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(-4Np+6\right)e^{\left(3-Np\right)0}\left(pe^0+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^4\left(N-1\right)\left(N-2\right)\left(N-3\right)e^{\left(4-Np\right)0}\left(pe^0+1-p\right)^{N-4}\nonumber\\
  &=N^4p^4\left(p+1-p\right)^N\nonumber\\
  &\quad+Np\left(2Np-1\right)\left(-2N^2p^2+2Np-1\right)\left(p+1-p\right)^{N-1}\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(6N^2p^2-12Np+7\right)\left(p+1-p\right)^{N-2}\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(-4Np+6\right)\left(p+1-p\right)^{N-3}\nonumber\\
  &\quad+Np^4\left(N-1\right)\left(N-2\right)\left(N-3\right)\left(p+1-p\right)^{N-4}\nonumber\\
  &=N^4p^4\nonumber\\
  &\quad+Np\left(2Np-1\right)\left(-2N^2p^2+2Np-1\right)\nonumber\\
  &\quad+Np^2\left(N-1\right)\left(6N^2p^2-12Np+7\right)\nonumber\\
  &\quad+Np^3\left(N-1\right)\left(N-2\right)\left(-4Np+6\right)\nonumber\\
  &\quad+Np^4\left(N-1\right)\left(N-2\right)\left(N-3\right)\nonumber\\
  &=N^4p^4\nonumber\\
  &\quad-4N^4p^4+6N^3p^3-4N^2p^2+Np\nonumber\\
  &\quad+6N^4p^4-12N^3p^3+7N^2p^2-6N^3p^4+12N^2p^3-7Np^2\nonumber\\
  &\quad-4N^4p^4+6N^3p^3+12N^3p^4-18N^2p^3-8N^2p^4+12Np^3\nonumber\\
  &\quad+N^4p^4-6N^3p^4+11N^2p^4-6Np^4\nonumber\\
  &=3N^2p^2+Np-6N^2p^3-7Np^2+3N^2p^4+12Np^3-6Np^4\nonumber\\
  &=-6Np^4+12Np^3-7Np^2+Np
 \end{align}
 \subsection{歪度}
 \begin{align}
  S\left(X\right)&=\frac{M_{X-E\left(X\right)}^{\left(3\right)}\left(0\right)}{\sigma\left(X\right)^3}\nonumber\\
  &=\frac{Np\left(1-p\right)\left(1-2p\right)}{\sqrt{Np\left(1-p\right)}^3}\nonumber\\
  &=\frac{Np\left(1-p\right)\left(1-2p\right)}{Np\left(1-p\right)\sqrt{Np\left(1-p\right)}}\nonumber\\
