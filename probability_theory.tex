...
よって，
 \begin{align}
  E\left(\left(X-E\left(X\right)\right)^4\right)&=K_X^{\left(4\right)}\left(0\right)\nonumber\\
  &=\left(1-p\right)\frac{\left(1-p\right)^2+4\left(1-p\right)+1}{\left(1-\left(1-p\right)\right)^4}\nonumber\\
...
よって，
 \begin{align}
  S\left(X\right)&=\frac{K_X^{\left(3\right)}\left(0\right)}{K_X^{\left(2\right)}\left(0\right)^\frac{3}{2}}\nonumber\\
  &=\frac{2}{\left(\lambda-t\right)^3}\left(\frac{1}{\lambda^2}\right)^{-\frac{3}{2}}\nonumber\\
