...
ここで，部分集合$S_{ij}$の濃度に応じて何らかの実数を返す関数
 \begin{align}
  &f:\{S_i|i\in I\}\to\mathbb{R}\\
  &g:\{S_{ij}|i\in I\land j\in J\left(i\right)\}\to\mathbb{R}:S_{ij}\mapsto f\left(S_i\right)
 \end{align}
を考えた時，分けられた部分集合族に渡るそれらの総積
 \begin{align}
  \prod_{i\in I\land j\in J\left(i\right)}g\left(S_{ij}\right)&=\prod_{i\in I\land j\in J\left(i\right)}f\left(S_i\right)\nonumber\\
  &=\prod_{i\in I}f\left(S_i\right)^{|J\left(i\right)|}
 \end{align}
...
この流れに合わせて関数$f$を組み込むために，$i$を固定した形
 \begin{align}
  f\left(S_i\right)^{|J\left(i\right)|}\label{BellWeight}
 \end{align}
を用いる．
...
\ref{BellWeight}を\ref{BellDetailEnumerationWithDuplication}に組み込むと，
 \begin{align}
  \frac{\left(i|J\left(i\right)|\right)!}{\left(i!\right)^{|J\left(i\right)|}}f\left(S_i\right)^{|J\left(i\right)|}&=\left(i|J\left(i\right)|\right)!\frac{f\left(S_i\right)^{|J\left(i\right)|}}{\left(i!\right)^{|J\left(i\right)|}}\nonumber\\
  &=\left(i|J\left(i\right)|\right)!\left(\frac{f\left(S_i\right)}{\left(i!\right)}\right)^{|J\left(i\right)|}
 \end{align}
