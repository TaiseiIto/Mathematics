...
\begin{document}
 ...
 \section{連続確率変数}
  ...
  \subsection{関数の適用}
   ...
   \begin{align}
    ...
    &=\dv{b}\int_{x\in S|f\left(x\right)<b}p\left(x\right)dx
   \end{align}
   ...
   \subsubsection{平均}
    ...
    \begin{align}
     ...
     &=\int_{-\infty}^\infty\frac{f\left(x\right)p\left(x\right)}{f'\left(x\right)}\dv{y}{x}dx\nonumber\\
   ...
   \subsubsection{分散}
    ...
    \begin{align}
     ...
     &=\int_{-\infty}^\infty\left(f\left(x\right)-E\left(f\left(X\right)\right)\right)^2\frac{p\left(x\right)}{f'\left(x\right)}\dv{y}{x}dx\nonumber\\
 ...
 \section{確率母関数}
  ...
  \subsection{確率母関数と階乗積率の関係}
   ...
   \subsubsection{証明}
    ...
    \begin{align}
     G_X\left(t\right)&=E\left(t^X\right)\nonumber\\
     \sum_{n=0}^\infty\frac{\left(t-1\right)^n}{n!}G_X^{\left(n\right)}\left(1\right)&=\sum_{n=1}^\infty\frac{\left(t-1\right)^n}{n!}\left(\left.\dv[n]{E\left(t^X\right)}{t}\right|_{t=1}\right)\nonumber\\
     G_X^{\left(n\right)}\left(1\right)&=\left.\dv[n]{E\left(t^X\right)}{t}\right|_{t=1}\nonumber\\
     &=\left.\dv[n]{t}\sum_{m=0}^\infty p\left(m\right)t^m\right|_{t=1}\nonumber\\
     &=\left.\sum_{m=0}^\infty p\left(m\right)\dv[n]{t}t^m\right|_{t=1}\nonumber\\
  ...
  \subsection{積率母関数と原点積率の関係}
   ...
   \subsubsection{証明}
    ...
    \begin{align}
     M_X\left(t\right)&=G_X\left(e^t\right)\nonumber\\
     &=E\left(e^{tX}\right)\nonumber\\
     \sum_{n=0}^\infty\frac{t^n}{n!}M_X^{\left(n\right)}\left(0\right)&=\sum_{n=0}^\infty\frac{t^n}{n!}\left(\left.\dv[n]{t}E\left(e^{tX}\right)\right|_{t=0}\right)\nonumber\\
     M_X^{\left(n\right)}\left(0\right)&=\left(\left.\dv[n]{t}E\left(e^{tX}\right)\right|_{t=0}\right)\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{t^m}{m!}\left(\left.\dv[m]{e^{tX}}{t}\right|_{t=0}\right)\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{t^m}{m!}\left(\left.X^me^{tX}\right|_{t=0}\right)\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{t^m}{m!}X^m\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}\sum_{m=0}^\infty\frac{t^m}{m!}E\left(X^m\right)\right|_{t=0}\nonumber\\
     &=\left.\sum_{m=0}^\infty\frac{E\left(X^m\right)}{m!}\dv[n]{t^m}{t}\right|_{t=0}\nonumber\\
  ...
  \subsection{特性関数と原点積率の関係}
   ...
   \subsubsection{証明}
    ...
    \begin{align}
     ...
     &=G_X\left(e^{it}\right)\nonumber\\
     &=E\left(e^{itX}\right)\nonumber\\
     \sum_{n=0}^\infty\frac{t^n}{n!}\phi_X^{\left(n\right)}\left(0\right)&=\sum_{n=0}^\infty\frac{t^n}{n!}\left(\left.\dv[n]{t}E\left(e^{itX}\right)\right|_{t=0}\right)\nonumber\\
     \phi_X^{\left(n\right)}\left(0\right)&=\left.\dv[n]{t}E\left(e^{itX}\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{t^m}{m!}\left(\left.\dv[m]{e^{itX}}{t}\right|_{t=0}\right)\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{t^m}{m!}\left(\left.\left(iX\right)^me^{itX}\right|_{t=0}\right)\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{t^m}{m!}\left(iX\right)^m\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}E\left(\sum_{m=0}^\infty\frac{i^mt^m}{m!}X^m\right)\right|_{t=0}\nonumber\\
     &=\left.\dv[n]{t}\sum_{m=0}^\infty\frac{i^mt^m}{m!}E\left(X^m\right)\right|_{t=0}\nonumber\\
     &=\left.\sum_{m=0}^\infty\frac{i^mE\left(X^m\right)}{m!}\dv[n]{t^m}{t}\right|_{t=0}\nonumber\\
 ...
 \section{キュムラント母関数}
  ...
  \subsection{Bellの多項式}
   ...
   \subsubsection{Fa\`a di Brunoの公式}
    ...
    \begin{align}
     \dv[n]{x}f\left(g\left(x\right)\right)=\sum_{k=1}^nf^{\left(k\right)}\left(g\left(x\right)\right)B_{n,k}\left(g^{\left(1\right)}\left(x\right),\cdots,g^{\left(n-k+1\right)}\left(x\right)\right)
    \end{align}
    である．
    これがFa\`a di Brunoの公式である．
    これを証明するために以下の補題
    \begin{align}
     \forall n\in\mathbb{N},\forall f\in C^n\left(\mathbb{R}^\mathbb{R}\right),\dv[n]{f\left(x\right)}{x}=\dv[n]{f\left(x\right)}{\left(x+y\right)}
    \end{align}
    を数学的帰納法により証明する．
    $n=1$の時，
    \begin{align}
     \dv{f\left(x\right)}{x}&=\dv{f\left(x\right)}{\left(x+y\right)}\dv{\left(x+y\right)}{x}\nonumber\\
     &=\dv{f\left(x\right)}{\left(x+y\right)}
    \end{align}
    また，
    \begin{align}
     \exists n\in\mathbb{N},\dv[n]{f\left(x\right)}{x}=\dv[n]{f\left(x\right)}{\left(x+y\right)}
    \end{align}
    のとき，
    \begin{align}
     \dv[n+1]{f\left(x\right)}{x}&=\dv{x}\dv[n]{f\left(x\right)}{x}\nonumber\\
     &=\dv{x}\dv[n]{f\left(x\right)}{\left(x+y\right)}\nonumber\\
     &=\dv{\left(x+y\right)}\dv[n]{f\left(x\right)}{\left(x+y\right)}\dv{\left(x+y\right)}{x}\nonumber\\
     &=\dv{\left(x+y\right)}\dv[n]{f\left(x\right)}{\left(x+y\right)}\nonumber\\
     &=\dv[n+1]{f\left(x\right)}{\left(x+y\right)}
    \end{align}
    よって数学的帰納法により補題が成り立つ．
    ...
    \begin{align}
     F\left(x,y\right)&=\sum_{k=0}^\infty\frac{1}{k!}\left(\left.\pdv[n]{F\left(x,y\right)}{y}\right|_{y=0}\right)y^k\nonumber\\
     &=\sum_{k=0}^\infty\frac{1}{k!}\left(\left.\pdv[n]{f\left(g\left(x\right)+y\right)}{y}\right|_{y=0}\right)y^k\nonumber\\
     &=\sum_{k=0}^\infty\frac{1}{k!}\left(\left.\pdv{f\left(g\left(x\right)+y\right)}{\left(g\left(x\right)+y\right)}\right|_{y=0}\right)y^k\nonumber\\
     &=\sum_{k=0}^\infty\frac{f^{\left(n\right)}\left(g\left(x\right)\right)}{k!}y^k\nonumber\\
    \end{align}
    また，$G\left(x,y\right)$を$y$周りでマクローリン展開すると，
    \begin{align}
     G\left(x,y\right)&=\sum_{n=0}^\infty\frac{1}{n!}\left(\left.\pdv[n]{G\left(x,y\right)}{y}\right|_{y=0}\right)y^n\nonumber\\
     &=G\left(x,0\right)+\sum_{n=1}^\infty\frac{1}{n!}\left(\left.\pdv[n]{G\left(x,y\right)}{y}\right|_{y=0}\right)y^n\nonumber\\
     &=g\left(x\right)-g\left(x\right)+\sum_{n=1}^\infty\frac{1}{n!}\left(\left.\pdv[n]{\left(g\left(x+y\right)-g\left(x\right)\right)}{y}\right|_{y=0}\right)y^n\nonumber\\
     &=\sum_{n=1}^\infty\frac{1}{n!}\left(\left.\pdv[n]{g\left(x+y\right)}{y}\right|_{y=0}\right)y^n\nonumber\\
     &=\sum_{n=1}^\infty\frac{1}{n!}\left(\left.\pdv[n]{g\left(x+y\right)}{\left(x+y\right)}\right|_{y=0}\right)y^n\nonumber\\
    ...
    \begin{align}
     ...
     &=\sum_{n=0}^\infty\frac{1}{n!}\left(\left.\pdv[n]{f\left(g\left(x+y\right)\right)}{y}\right|_{y=0}\right)y^n\nonumber\\
     &=\sum_{n=0}^\infty\frac{1}{n!}\left(\left.\pdv[n]{f\left(g\left(x+y\right)\right)}{\left(x+y\right)}\right|_{y=0}\right)y^n\nonumber\\
     &=\sum_{n=0}^\infty\frac{1}{n!}\dv[n]{f\left(g\left(x\right)\right)}{x}y^n\nonumber\\
    \end{align}
    とも展開できる．
    $\forall n\in\mathbb{N}$に対して両者の$y^n$の項を比較すると，
    \begin{align}
     \frac{1}{n!}\dv[n]{f\left(g\left(x\right)\right)}{x}y^n&=\sum_{k=0}^n\frac{f^{\left(k\right)}\left(g\left(x\right)\right)}{n!}B_{n,k}\left(g^{\left(1\right)}\left(x\right),\cdots,g^{\left(n-k+1\right)}\left(x\right)\right)y^n\nonumber\\
     \dv[n]{f\left(g\left(x\right)\right)}{x}&=\sum_{k=0}^nf^{\left(k\right)}\left(g\left(x\right)\right)B_{n,k}\left(g^{\left(1\right)}\left(x\right),\cdots,g^{\left(n-k+1\right)}\left(x\right)\right)\nonumber\\
  ...
  \subsection{積率からキュムラントを求める}
   ...
   \begin{align}
    ...
    \sum_{n=0}^\infty\frac{t^n}{n!}K_X^{\left(n\right)}\left(0\right)&=\sum_{n=0}^\infty\frac{t^n}{n!}\left(\left.\dv[n]{\log M_X\left(t\right)}{t}\right|_{t=0}\right)\nonumber\\
    K_X^{\left(n\right)}\left(0\right)&=\left.\dv[n]{\log M_X\left(t\right)}{t}\right|_{t=0}\nonumber\\
  ...
  \subsection{キュムラントから積率を求める}
   ...
   \begin{align}
    ...
    \sum_{n=0}^\infty\frac{t^n}{n!}M_X^{\left(n\right)}\left(0\right)&=\sum_{n=0}^\infty\frac{t!}{n!}\left(\left.\dv[n]{e^{K_X\left(t\right)}}{t}\right|_{t=0}\right)\nonumber\\
    M_X^{\left(n\right)}\left(0\right)&=\left.\dv[n]{e^{K_X\left(t\right)}}{t}\right|_{t=0}\nonumber\\
    &=\left.\sum_{k=1}^n\dv[k]{e^{K_X\left(t\right)}}{K_X\left(t\right)}B_{n,k}\left(K_X^{\left(1\right)}\left(t\right),\cdots,K_X^{\left(n-k+1\right)}\left(t\right)\right)\right|_{t=0}\nonumber\\
 ...
 \section{離散一様分布}
  ...
  \subsection{積率母関数}
   \begin{align}
    ...
    M_X^{\left(m\right)}\left(t\right)&=\dv[m]{t}\frac{1}{n}\sum_{x=1}^ne^{tx}\nonumber\\
    &=\frac{1}{n}\sum_{x=1}^n\dv[m]{e^{tx}}{t}\nonumber\\
  ...
  \subsection{中心積率母関数}
   \begin{align}
    ...
    M_{X-E\left(X\right)}^{\left(m\right)}\left(t\right)&=\dv[m]{t}\frac{1}{n}\sum_{x=1}^ne^{\left(x-\frac{n+1}{2}\right)t}\nonumber\\
    &=\frac{1}{n}\sum_{x=1}^n\dv[m]{t}e^{\left(x-\frac{n+1}{2}\right)t}\nonumber\\
 ...
 \section{連続一様分布}
  ...
  \subsection{キュムラント母関数}
   \begin{align}
    ...
    K_X^{\left(1\right)}\left(t\right)&=\dv{t}K_X\left(t\right)\nonumber\\
    &=\dv{t}\left(\log\left(e^{at}-1\right)-\log t-\log a\right)\nonumber\\
    &=\dv{t}\log\left(e^{at}-1\right)-\dv{t}\log t-\dv{t}\log a\nonumber\\
    &=\frac{\dv{t}\left(e^{at}-1\right)}{e^{at}-1}-\frac{1}{t}\nonumber\\
   ...
   \begin{align}
    \dv[n]{t}e^{at}&=a^ne^{at}\nonumber\\
    \left[\dv[n]{t}e^{at}\right]_{t=0}&=a^n\nonumber\\
   ...
   また，対数関数のテイラー展開は，
   \begin{align}
    \dv[n]{x}\log\left(x+1\right)&=-\left(-1\right)^n\left(n-1\right)!\left(x+1\right)^{-n}\nonumber\\
    \left[\dv[n]{x}\log\left(x+1\right)\right]_{x=0}&=-\left(-1\right)^n\left(n-1\right)!\nonumber\\
 ...
 \section{二項分布}
  ...
  \subsection{キュムラント母関数}
   ...
   \begin{align}
    K_X^{\left(1\right)}\left(t\right)&=\dv{t}K_X\left(t\right)\nonumber\\
    &=\dv{t}N\log\left(pe^t+1-p\right)\nonumber\\
    &=N\dv{t}\log\left(pe^t+1-p\right)\nonumber\\
    &=N\frac{\dv{t}\left(pe^t+1-p\right)}{pe^t+1-p}\nonumber\\
   ...
   \end{align}
   \begin{align}
    K_X^{\left(2\right)}\left(t\right)&=\dv{t}K_X^{\left(1\right)}\left(t\right)\nonumber\\
    &=\dv{t}Np\frac{e^t}{pe^t+1-p}\nonumber\\
    &=Np\dv{t}\frac{e^t}{pe^t+1-p}\nonumber\\
    &=Np\frac{\left(\dv{t}e^t\right)\left(pe^t+1-p\right)-e^t\left(\dv{t}\left(pe^t+1-p\right)\right)}{\left(pe^t+1-p\right)^2}\nonumber\\
   ...
   \end{align}
   \begin{align}
    K_X^{\left(3\right)}\left(t\right)&=\dv{t}K_X^{\left(2\right)}\left(t\right)\nonumber\\
    &=\dv{t}Np\left(1-p\right)\frac{e^t}{\left(pe^t+1-p\right)^2}\nonumber\\
    &=Np\left(1-p\right)\dv{t}\frac{e^t}{\left(pe^t+1-p\right)^2}\nonumber\\
    &=Np\left(1-p\right)\frac{\left(\dv{t}e^t\right)\left(pe^t+1-p\right)^2-e^t\left(\dv{t}\left(pe^t+1-p\right)^2\right)}{\left(pe^t+1-p\right)^4}\nonumber\\
    &=Np\left(1-p\right)\frac{e^t\left(pe^t+1-p\right)^2-e^t\left(2\left(pe^t+1-p\right)\dv{t}\left(pe^t+1-p\right)\right)}{\left(pe^t+1-p\right)^4}\nonumber\\
   ...
   \end{align}
   \begin{align}
    K_X^{\left(4\right)}\left(t\right)&=\dv{t}K_X^{\left(3\right)}\left(t\right)\nonumber\\
    &=\dv{t}Np\left(1-p\right)\frac{\left(1-p\right)e^t-pe^{2t}}{\left(pe^t+1-p\right)^3}\nonumber\\
    &=Np\left(1-p\right)\dv{t}\frac{\left(1-p\right)e^t-pe^{2t}}{\left(pe^t+1-p\right)^3}\nonumber\\
    &=Np\left(1-p\right)\frac{\left(\dv{t}\left(\left(1-p\right)e^t-pe^{2t}\right)\right)\left(pe^t+1-p\right)^3-\left(\left(1-p\right)e^t-pe^{2t}\right)\left(\dv{t}\left(pe^t+1-p\right)^3\right)}{\left(pe^t+1-p\right)^6}\nonumber\\
    &=Np\left(1-p\right)\frac{\left(\dv{t}\left(\left(1-p\right)e^t-pe^{2t}\right)\right)\left(pe^t+1-p\right)^3-\left(\left(1-p\right)e^t-pe^{2t}\right)\left(\dv{t}\left(pe^t+1-p\right)^3\right)}{\left(pe^t+1-p\right)^6}\nonumber\\
    &=Np\left(1-p\right)\frac{\left(\left(1-p\right)e^t-2pe^{2t}\right)\left(pe^t+1-p\right)^3-\left(\left(1-p\right)e^t-pe^{2t}\right)\left(3\left(pe^t+1-p\right)^2\dv{t}\left(pe^t+1-p\right)\right)}{\left(pe^t+1-p\right)^6}\nonumber\\
 ...
 \section{幾何分布}
  ...
  \subsection{平均}
   \begin{align}
    K_X^{\left(1\right)}\left(t\right)&=\dv{t}K_X\left(t\right)\nonumber\\
    &=\dv{t}\left(t+\log p-\log\left(1-\left(1-p\right)e^t\right)\right)\nonumber\\
    &=\dv{t}t+\dv{t}\log p-\dv{t}\left(\log\left(1-\left(1-p\right)e^t\right)\right)\nonumber\\
    &=1-\frac{\dv{t}\left(1-\left(1-p\right)e^t\right)}{1-\left(1-p\right)e^t}\nonumber\\
  ...
  \subsection{分散}
   ...
   \begin{align}
    K_X^{\left(2\right)}\left(t\right)&=\dv{t}K_X^{\left(1\right)}\left(t\right)\nonumber\\
    &=\dv{t}\frac{1}{1-\left(1-p\right)e^t}\nonumber\\
    &=\dv{t}\frac{1}{1-f\left(t\right)}\nonumber\\
    &=-\frac{\dv{t}\left(1-f\left(t\right)\right)}{\left(1-f\left(t\right)\right)^2}\nonumber\\
  ...
  \subsection{歪度}
   \begin{align}
    K_X^{\left(3\right)}\left(t\right)&=\dv{t}K_X^{\left(2\right)}\left(t\right)\nonumber\\
    &=\dv{t}\frac{f\left(t\right)}{\left(1-f\left(t\right)\right)^2}\nonumber\\
    &=\frac{\dv{f\left(t\right)}{t}\left(1-f\left(t\right)\right)^2-f\left(t\right)\dv{\left(1-f\left(t\right)\right)^2}{t}}{\left(1-f\left(t\right)\right)^4}\nonumber\\
  ...
  \subsection{超過尖度}
   \begin{align}
    K_X^{\left(4\right)}\left(t\right)&=\dv{t}K_X^{\left(3\right)}\left(t\right)\nonumber\\
    &=\dv{t}\frac{f\left(t\right)-f\left(t\right)^3}{\left(1-f\left(t\right)\right)^4}\nonumber\\
    &=\frac{\dv{\left(f\left(t\right)-f\left(t\right)^3\right)}{t}\left(1-f\left(t\right)\right)^4-\left(f\left(t\right)-f\left(t\right)^3\right)\dv{\left(1-f\left(t\right)\right)^4}{t}}{\left(1-f\left(t\right)\right)^8}\nonumber\\
    &=\frac{\left(\dv{\left(f\left(t\right)\right)}{t}-\dv{f\left(t\right)^3}{t}\right)\left(1-f\left(t\right)\right)^4-\left(f\left(t\right)-f\left(t\right)^3\right)4\left(1-f\left(t\right)\right)^3\dv{\left(1-f\left(t\right)\right)}{t}}{\left(1-f\left(t\right)\right)^8}\nonumber\\
 ...
 \section{指数分布}
  ...
  \subsection{平均}
   \begin{align}
    K_X^{\left(1\right)}\left(t\right)&=\dv{t}K_X\left(t\right)\nonumber\\
    &=\dv{t}\left(\log\lambda-\log\left(\lambda-t\right)\right)\nonumber\\
    &=\dv{\log\lambda}{t}-\dv{\log\left(\lambda-t\right)}{t}\nonumber\\
    &=-\frac{1}{\lambda-t}\dv{\left(\lambda-t\right)}{t}\nonumber\\
    &=\frac{1}{\lambda-t}\nonumber\\
    E\left(X\right)&=K_X^{\left(1\right)}\left(0\right)\nonumber\\
    &=\frac{1}{\lambda}
   \end{align}
  \subsection{分散}
   \begin{align}
    K_X^{\left(2\right)}\left(t\right)&=\dv{t}K_X^{\left(1\right)}\left(t\right)\nonumber\\
    &=\dv{t}\frac{1}{\lambda-t}\nonumber\\
    &=-\frac{1}{\left(\lambda-t\right)^2}\dv{\left(\lambda-t\right)}{t}\nonumber\\
  ...
  \subsection{歪度}
   \begin{align}
    K_X^{\left(3\right)}\left(t\right)&=\dv{t}K_X^{\left(2\right)}\left(t\right)\nonumber\\
    &=\dv{t}\frac{1}{\left(\lambda-t\right)^2}\nonumber\\
    &=-\frac{2}{\left(\lambda-t\right)^3}\dv{\left(\lambda-t\right)}{t}\nonumber\\
  ...
  \subsection{超過尖度}
   \begin{align}
    K_X^{\left(4\right)}\left(t\right)&=\dv{t}K_X^{\left(3\right)}\left(t\right)\nonumber\\
    &=\dv{t}\frac{2}{\left(\lambda-t\right)^3}\nonumber\\
    &=-\frac{6}{\left(\lambda-t\right)^4}\dv{\left(\lambda-t\right)}{t}\nonumber\\
 ...
 \section{ポアソン分布}
  ...
  確かに，
  \begin{align}
   \sum_{n\in S\left(X\right)}p\left(n\right)&=\sum_{n=0}^\infty\frac{\lambda^n}{n!e^\lambda}\nonumber\\
   &=\frac{1}{e^\lambda}\sum_{n=0}^\infty\frac{\lambda^n}{n!}\nonumber\\
  ...
  \subsection{確率母関数}
   \begin{align}
    G_X\left(t\right)&=E\left(t^X\right)\nonumber\\
    &=\sum_{n\in S\left(X\right)}t^np\left(n\right)\nonumber\\
    &=\sum_{n=0}^\infty \frac{t^n\lambda^n}{n!e^\lambda}\nonumber\\
    &=\frac{1}{e^\lambda}\sum_{n=0}^\infty \frac{\left(t\lambda\right)^n}{n!}\nonumber\\
    &=\frac{e^{t\lambda}}{e^\lambda}\nonumber\\
    &=e^{\lambda\left(t-1\right)}
   \end{align}
  \subsection{積率母関数}
   \begin{align}
    M_X\left(t\right)&=G_X\left(e^t\right)\nonumber\\
  ...
  \subsection{キュムラント母関数}
   \begin{align}
    K_X\left(t\right)&=\log M_X\left(t\right)\nonumber\\
    &=\log e^{\lambda\left(e^t-1\right)}\nonumber\\
    &=\lambda\left(e^t-1\right)
   \end{align}
  \subsection{平均}
   \begin{align}
    K_X^{\left(1\right)}\left(t\right)&=\dv{t}\lambda\left(e^t-1\right)\nonumber\\
    &=\lambda\dv{t}\left(e^t-1\right)\nonumber\\
    &=\lambda e^t
   \end{align}
   よって平均は，
   \begin{align}
  ...
  \subsection{エントロピー}
   \begin{align}
    H\left(X\right)&=E\left(-\log_2p\left(X\right)\right)\nonumber\\
    &=-E\left(\log_2\frac{\lambda^X}{X!e^\lambda}\right)\nonumber\\
    &=-E\left(\log_2\frac{2^{X\log_2\lambda}}{X!2^{\lambda\log_2e}}\right)\nonumber\\
    &=-E\left(X\log_2\lambda-\log_2X!-\lambda\log_2e\right)\nonumber\\
    &=-E\left(X\log_2\lambda-\lambda\log_2e-\log_2\prod_{m=1}^Xm\right)\nonumber\\
    &=-E\left(X\log_2\lambda-\lambda\log_2e-\sum_{m=1}^X\log_2m\right)\nonumber\\
    &=-E\left(X\right)\log_2\lambda+\lambda\log_2e+E\left(\sum_{m=1}^X\log_2m\right)\nonumber\\
    &=-\lambda\log_2\lambda+\lambda\log_2e+\sum_{n=0}^\infty p\left(n\right)\sum_{m=1}^n\log_2m\nonumber\\
    &=\lambda\log_2e-\lambda\log_2\lambda+\sum_{n=0}^\infty\frac{\lambda^n}{n!e^\lambda}\sum_{m=1}^n\log_2m\nonumber\\
    &=\lambda\log_2e-\lambda\log_2\lambda+\frac{1}{e^{\lambda}}\sum_{n=0}^\infty\frac{\lambda^n}{n!}\sum_{m=1}^n\log_2m
   \end{align}
 \section{標準正規分布}
  \subsection{ポアソン分布から標準正規分布を導出}
   確率変数$X$が平均$\lambda$のポアソン分布に従うとき，
   \begin{align}
    \lim_{\lambda\to\infty}\frac{X-\lambda}{\sqrt{\lambda}}
   \end{align}
   は標準正規分布に従う連続確率変数である．
   以下でそのことを証明する．
   ...
   \subsubsection{上界を持つ単調増加数列の収束}
    単調増加数列
    \begin{align}
     &f:\mathbb{N}\to\mathbb{R}\\
     &\forall n\in\mathbb{N},f\left(n\right)<f\left(n+1\right)
    \end{align}
    ...
    \end{align}
   \subsubsection{自然数の$-2$乗の和の収束}
    数列
    \begin{align}
     \forall N\in\mathbb{N},a_N=\sum_{n=1}^N\frac{1}{n^2}
    \end{align}
    が収束することを証明する．
    \begin{align}
     ...
     \forall N\in\mathbb{N},\sum_{n=1}^N\frac{1}{n^2}=1+\sum_{n=2}^N\frac{1}{n^2}&<1+\sum_{n=2}^N\frac{1}{n\left(n-1\right)}\nonumber\\
     &=1+\sum_{n=2}^N\frac{n-\left(n-1\right)}{n\left(n-1\right)}\nonumber\\
     &=1+\sum_{n=2}^N\left(\frac{1}{n-1}-\frac{1}{n}\right)\nonumber\\
     &=1+\left(\sum_{n=2}^N\frac{1}{n-1}\right)-\left(\sum_{n=2}^N\frac{1}{n}\right)\nonumber\\
     &=1+\left(\sum_{n=1}^{N-1}\frac{1}{n}\right)-\left(\sum_{n=2}^N\frac{1}{n}\right)\nonumber\\
     &=1+1-\frac{1}{N}\nonumber\\
     &=2-\frac{1}{N}\nonumber\\
    ...
    また，
    \begin{align}
     a_{N+1}-a_N&=\frac{1}{\left(N+1\right)^2}>0
    \end{align}
    よって単調増加である．
    よって収束する．
   \subsubsection{無限数列の和が収束するならば数列は$0$に収束}
    \begin{align}
     s=\sum_{n=1}^\infty f\left(n\right)
    \end{align}
    のとき，部分和を，
    \begin{align}
     s\left(m\right)=\sum_{n=1}^m f\left(n\right)
    \end{align}
    とすると，
    \begin{align}
     f\left(m\right)&=s\left(m\right)-s\left(m-1\right)\nonumber\\
     &=\left(\sum_{n=1}^m f\left(n\right)\right)-\left(\sum_{n=1}^{m-1} f\left(n\right)\right)\nonumber\\
     \lim_{m\to\infty}f\left(m\right)&=\left(\lim_{m\to\infty}\sum_{n=1}^m f\left(n\right)\right)-\left(\lim_{m\to\infty}\sum_{n=1}^{m-1} f\left(n\right)\right)\nonumber\\
     &=s-s\nonumber\\
     &=0
    \end{align}
   \subsubsection{$\sin$の無限乗積の収束}
    \begin{align}
     \forall x\in\mathbb{R},\sum_{n=1}^\infty\left|f\left(n\right)\right|\in\mathbb{R}\implies\prod_{n=1}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\mathbb{R}
    \end{align}
    を証明する．
    無限数列の和が収束するならば数列は$0$に収束することから，
    \begin{align}
     \sum_{n=1}^\infty\left|f\left(n\right)\right|\in\mathbb{R}
    \end{align}
    より，
    \begin{align}
     \exists N\in\mathbb{N},\forall n\in{}_{N\le}\mathbb{N},\left|f\left(n\right)\right|\in\left(0,2^{-1}\right]
    \end{align}
    であり，
    \begin{align}
     \prod_{n=1}^\infty\left(1-\left|f\left(n\right)\right|\right)=\prod_{n=1}^{N-1}\left(1-\left|f\left(n\right)\right|\right)\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)
    \end{align}
    ここで，明らかに
    \begin{align}
     \prod_{n=1}^{N-1}\left(1-\left|f\left(n\right)\right|\right)\in\mathbb{R}
    \end{align}
    だから，
    \begin{align}
     \prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\mathbb{R}
    \end{align}
    さえ示せば良い．
    もし収束するならば，
    \begin{align}
     \forall n\in{}_{N\le}\mathbb{N},&\left|f\left(n\right)\right|\in\left(0,2^{-1}\right]\nonumber\\
     &\implies 1-\left|f\left(n\right)\right|\in\left[2^{-1},1\right)\nonumber\\
     &\implies\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\left(0,1\right)\nonumber\\
     &\implies\log\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\mathbb{R}_{<0}\nonumber\\
     &\implies-\log\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in{}_{0<}\mathbb{R}
    \end{align}
    であるから，$-\log\left(1-x\right)$のマクローリン展開
    \begin{align}
     -\log\left(1-x\right)=\sum_{n=1}^\infty\frac{x^n}{n}
    \end{align}
    を使って，
    \begin{align}
     -\log\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)&=-\sum_{n=N}^\infty\log\left(1-\left|f\left(n\right)\right|\right)\nonumber\\
     &=\sum_{n=N}^\infty\sum_{m=1}^\infty\frac{\left|f\left(n\right)\right|^m}{m}\nonumber\\
     &=\sum_{n=N}^\infty\left|f\left(n\right)\right|\sum_{m=1}^\infty\frac{\left|f\left(n\right)\right|^{m-1}}{m}\nonumber\\
     &=\sum_{n=N}^\infty\left|f\left(n\right)\right|\sum_{m=0}^\infty\frac{\left|f\left(n\right)\right|^m}{m+1}\nonumber\\
     &=\sum_{n=N}^\infty\left|f\left(n\right)\right|\left(1+\sum_{m=1}^\infty\frac{\left|f\left(n\right)\right|^m}{m+1}\right)\nonumber\\
     &<\sum_{n=N}^\infty\left|f\left(n\right)\right|\left(1+\sum_{m=1}^\infty\frac{\left|f\left(n\right)\right|^m}{m}\right)\nonumber\\
     &=\sum_{n=N}^\infty\left|f\left(n\right)\right|\left(1-\log\left(1-\left|f\left(n\right)\right|\right)\right)\nonumber\\
     &<\sum_{n=N}^\infty\left|f\left(n\right)\right|\left(1-\log\left(1-2^{-1}\right)\right)\nonumber\\
     &=\sum_{n=N}^\infty\left|f\left(n\right)\right|\left(1-\log 2^{-1}\right)\nonumber\\
     &=\sum_{n=N}^\infty\left|f\left(n\right)\right|\left(1+\log 2\right)\nonumber\\
     &=\left(1+\log 2\right)\sum_{n=N}^\infty\left|f\left(n\right)\right|
    \end{align}
    よって
    \begin{align}
     &-\log\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\left(0,\left(1+\log 2\right)\sum_{n=N}^\infty\left|f\left(n\right)\right|\right)\nonumber\\
     &\log\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\left(-\left(1+\log 2\right)\sum_{n=N}^\infty\left|f\left(n\right)\right|,0\right)\nonumber\\
     &\prod_{n=N}^\infty\left(1-\left|f\left(n\right)\right|\right)\in\left(\exp\left(-\left(1+\log 2\right)\sum_{n=N}^\infty\left|f\left(n\right)\right|\right),1\right)\nonumber\\
    \end{align}
    よって収束する．
    \begin{align}
    ...
    よって，
    \begin{align}
     x^2\sum_{n=1}^\infty\frac{1}{n^2}=\sum_{n=1}^\infty\frac{x^2}{n^2}
    \end{align}
    も収束し，
    \begin{align}
    ...
    \end{align}
    も収束する．
   \subsubsection{三角関数の部分分数分解}
   \subsubsection{$\sin$の無限乗積展開}
   \subsubsection{ウォリスの公式}
   \subsubsection{スターリングの近似}
   \subsubsection{本証明}
  \subsection{確率母関数}
  \subsection{積率母関数}
  \subsection{特性関数}
  ...
  \subsection{エントロピー}
 \section{正規分布}
  標準正規分布の平均及び標準偏差に自由度を与えたものが正規分布である．
  \subsection{確率母関数}
  \subsection{積率母関数}
  \subsection{特性関数}
  \subsection{キュムラント母関数}
