...
ベルヌーイ分布に従う互いに独立な$N$個の確率変数$X_1,\cdots,X_N$の和
 \begin{align}
  X&=\sum_{n=1}^NX_n
 \end{align}
を二項分布といい，その標本空間は$S\left(X\right)=\{0,\cdots,N\}$である．
...
よって，
 ...
 \begin{align}
  ...
  &=-\frac{\frac{d}{dt}\left(1-\left(1-p\right)e^t\right)}{\left(1-\left(1-p\right)e^t\right)^2}\nonumber\\
...
よって，
 ...
 \begin{align}
  K_X^{\left(3\right)}\left(t\right)&=\frac{d}{dt}K_X^{\left(2\right)}\left(t\right)\nonumber\\
  &=\frac{d}{dt}\frac{\left(1-p\right)e^t}{\left(1-\left(1-p\right)e^t\right)^2}\nonumber\\
  &=\frac{\frac{d\left(1-p\right)e^t}{dt}\left(1-\left(1-p\right)e^t\right)^2-\left(1-p\right)e^t\frac{d\left(1-\left(1-p\right)e^t\right)^2}{dt}}{\left(1-\left(1-p\right)e^t\right)^4}\nonumber\\
  &=\frac{\left(1-p\right)e^t\left(1-\left(1-p\right)e^t\right)^2-\left(1-p\right)e^t2\left(1-\left(1-p\right)e^t\right)\frac{d\left(1-\left(1-p\right)e^t\right)}{dt}}{\left(1-\left(1-p\right)e^t\right)^4}\nonumber\\
  &=\frac{\left(1-p\right)e^t\left(1-\left(1-p\right)e^t\right)^2+2\left(1-p\right)e^t\left(1-\left(1-p\right)e^t\right)\left(1-p\right)e^t}{\left(1-\left(1-p\right)e^t\right)^4}\nonumber\\
 \end{align}
よって，
 \begin{align}
  S\left(X\right)&=\frac{E\left(\left(X-E\left(X\right)\right)^3\right)}{\sigma\left(X\right)^3}\nonumber\\
