...
よって成り立つ．
 ...
 \begin{align}
  ...
  E\left(\left(X-E\left(X\right)\right)^m\right)&=\frac{1}{n}\sum_{x=1}^n\sum_{k=1}^m\binom{m}{k}x^k\left(-\frac{n+1}{2}\right)^{m-k}
 \end{align}
 \subsection{歪度}
 ...
 \begin{align}
  ...
  \sum_{x=1}^nx^3&=\frac{n^2\left(n+1\right)^2}{4}
 \end{align}
 \subsection{尖度}
 ...
 \begin{align}
  ...
  \left(n+1\right)^5-1&=5\left(\sum_{x=1}^nx^4\right)+10\left(\frac{n^2\left(n+1\right)^2}{4}\right)+10\left(\frac{1}{6}n\left(n+1\right)\left(2n+1\right)\right)+5\left(\frac{1}{2}n\left(n+1\right)\right)+n\nonumber\\
  \left(n+1\right)^5-1&=5\left(\sum_{x=1}^nx^4\right)+\frac{5}{2}n^2\left(n+1\right)+\frac{5}{3}n\left(n+1\right)\left(2n+1\right)+\frac{5}{2}n\left(n+1\right)+n\nonumber\\
  6\left(n+1\right)^5-6&=30\left(\sum_{x=1}^nx^4\right)+15n^2\left(n+1\right)+10n\left(n+1\right)\left(2n+1\right)+15n\left(n+1\right)+6n\nonumber\\
 \end{align}
 \subsection{エントロピー}
 \section{連続一様分布}
 \subsection{確率母関数}
