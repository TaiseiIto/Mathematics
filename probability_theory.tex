  ...
  \subsection{ポアソン分布から標準正規分布を導出}
   ...
   \subsubsection{実数の連続性}
    ...
    \subsubsubsection{デデキント切断であることの証明}
     ...
     $\forall r\in R$について$r\in\mathbb{R}$より$\mathbb{Q}_{<r}$および${}_{r\le}\mathbb{Q}$が$r$におけるデデキント切断で$\mathbb{Q}_{<r}\cup{}_{r\le}\mathbb{Q}=\mathbb{Q}$となっていることにより，$\forall q\in\mathbb{Q}$について，$q\in\mathbb{Q}_{<x}$さもなければ$q\in{}_{x\le}\mathbb{Q}$であるから，$\mathbb{Q}\subset\mathbb{Q}_{<x}\cup{}_{x\le}\mathbb{Q}$である．
     よって$\mathbb{Q}_{<x}\cup{}_{x\le}\mathbb{Q}=\mathbb{Q}$である．
     $\forall q\in\mathbb{Q}_{<x}$について，$\exists r\in R,q\in\mathbb{Q}_{<r}$であり，$\mathbb{Q}_{<r}$と${}_{r\le}\mathbb{Q}$はデデキント切断であるから$\exists s\in\mathbb{Q}_{<r}\subset\mathbb{Q}_{<x},q<s$である．
