 ...
 \begin{figure}[H]
  \begin{center}
   \begin{tikzpicture}
    ...
    \draw({(2+2.2236)/2},{5*(1/(pi*(1+(2-4)^2)))/2})node{$\Delta s_0$};
    \draw[dashed](4,{5*(1/(pi*(1+(4-4)^2)))})--(4,0)node[above]{$a_1$};
    \draw[dashed](3.61019,{5*(1/(pi*(1+(3.61019-4)^2)))})--(3.61019,0.5)node[above]{$a_1+\Delta a_1$};
    \draw({(4+3.61019)/2},{5*(1/(pi*(1+(4-4)^2)))/2})node{$\Delta s_1$};
    ...
    \draw({(6+6.16621)/2},{5*(1/(pi*(1+(6-4)^2)))/2})node{$\Delta s_2$};
   \end{tikzpicture}
