...
よって超過尖度は，
 ...
 \begin{align}
  ...
  &=-\lambda\log_2\lambda+\lambda\log_2e+\sum_{n=0}^\infty\frac{\lambda^n}{n!e^\lambda}\sum_{m=1}^n\log_2m\nonumber\\
  &=-\lambda\log_2\lambda+\lambda\log_2e+\frac{1}{e^{\lambda}}\sum_{n=0}^\infty\frac{\lambda^n}{n!}\sum_{m=1}^n\log_2m
 \end{align}
 \section{正規分布}
正規分布は，ポアソン分布の拡張である．
 \subsection{確率母関数}
