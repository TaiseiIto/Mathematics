...
一方で，
 \begin{align}
  &E\left(\left(X-E\left(X\right)\right)^4\right)-3E\left(\left(X-E\left(X\right)\right)^2\right)^2\nonumber\\
...
よって，
 \begin{align}
  K_X^{\left(4\right)}\left(0\right)&=E\left(\left(X-E\left(X\right)\right)^4\right)-3E\left(\left(X-E\left(X\right)\right)^2\right)^2
 \end{align}
 \section{ベルヌーイ分布}
$\{0,1\}$を標本空間とし，確率質量関数を
 \begin{align}
