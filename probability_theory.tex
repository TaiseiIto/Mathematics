...
よって歪度は，
 ...
 \begin{align}
  ...
  &=\frac{n+1}{240}\left(8\left(n+1\right)\left(2n+1\right)\left(3n^2+3n-1\right)-120n\left(n+1\right)^3+60\left(n+1\right)^3\left(2n+1\right)-45\left(n+1\right)^4\right)\nonumber\\
 \end{align}
 \subsection{エントロピー}
 \section{連続一様分布}
 \subsection{確率母関数}
