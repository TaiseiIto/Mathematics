...
それぞれをマクローリン展開すると，
 ...
 \end{align}
だが，このとき$g\left(x\right)$の$m$次の項に注目すると，これは大きさ$m$の集合の全ての可能な$k$個の部分集合への分割を考え，元の集合から分割された各部分集合の大きさ$n$に応じた値，即ち$f\left(x\right)$の$n$次の項の総積として再統合し，それを全ての分割方法に渡って総和を取った値であるから，
 \begin{align}
