...
を，集合
 \begin{align}
  \{S_{ij}|i\in I=\{1,\cdots,|I|\}\land j\in J\left(i\right)=\{1,\cdots,|J\left(i\right)|\}\}
 \end{align}
に分けたい．
但し，
 \begin{align}
  S=\bigcup_{i\in I}\bigcup_{j\in J\left(i\right)}S_{ij}\\
  \forall i_1\in I,\forall j_1\in J\left(i_1\right),\forall i_2\in I,\forall j_2\in J\left(i_2\right),\left(i_1,j_1\right)=\left(i_2,j_2\right)\iff S_{i_1j_1}\cup S_{i_2j_2}\ne\emptyset\\
...
これらの場合の数は，
 \begin{align}
  \prod_{j\in J\left(i\right)}\binom{i\left(|J\left(i\right)|-j+1\right)}{i}\label{BellDetailEnumeration}
 \end{align}
\ref{BellOutlineEnumeration}および\ref{BellDetailEnumeration}を合わせると，場合の数は，
 \begin{align}
  \prod_{i\in I}\left(\binom{|S|-\sum_{k=1}^{i-1}k|J\left(k\right)|}{i|J\left(i\right)|}\prod_{j\in J\left(i\right)}\binom{i\left(|J\left(i\right)|-j+1\right)}{i}\right)
 \end{align}
