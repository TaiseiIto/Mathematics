...
これに$t=0$を代入すると，
 \begin{align}
  K^{\left(1\right)}_X\left(0\right)&=\frac{E\left(Xe^{0X}\right)}{E\left(e^{0X}\right)}\nonumber\\
...
これに$t=0$を代入すると，
 \begin{align}
  K^{\left(2\right)}_X\left(0\right)&=\frac{E\left(X^2e^{0X}\right)}{E\left(e^{0X}\right)}-\frac{E\left(Xe^{0X}\right)^2}{E\left(e^{0X}\right)^2}\nonumber\\
