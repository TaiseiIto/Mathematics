 ...
 \section{標準正規分布}
  \subsection{ポアソン分布から標準正規分布を導出}
   ...
   \subsubsection{上限，下限の定義}
    ...
    \begin{align}
     \forall S\in 2^\mathbb{R},S<\sup S\land\forall\epsilon\in\mathbb{R}_{>0},\exists x,x\in\left[\sup S-\epsilon,\sup S\right]
    \end{align}
    $\forall S\in 2^\mathbb{R}$の下限$\inf S$は以下を満たす．
    \begin{align}
     \forall S\in 2^\mathbb{R},\inf S<S\land\forall\epsilon\in\mathbb{R}_{>0},\exists x,x\in\left[\inf S,\inf S+\epsilon\right]
    \end{align}
