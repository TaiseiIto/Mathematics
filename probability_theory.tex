 ...
 \section{標準正規分布}
  \subsection{ポアソン分布から標準正規分布を導出}
   ...
   \subsubsection{上限，下限の定義}
    ...
    \begin{align}
     \forall R\subset\mathbb{R},R<\sup R\land\forall\epsilon\in{}_{0<}\mathbb{R},R\cap\left[\sup R-\epsilon,\sup R\right]\ne\emptyset
    \end{align}
    $\forall R\subset\mathbb{R}$の下限$\inf R$は以下を満たす．
    \begin{align}
     \forall R\subset\mathbb{R},\inf R<R\land\forall\epsilon\in{}_{0<}\mathbb{R},R\cap\left[\inf R,\inf R+\epsilon\right]\ne\emptyset
    \end{align}
