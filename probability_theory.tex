...
よって成り立つ．
 ...
 \begin{align}
  ...
  &=E\left(e^{Xt-\frac{n+1}{2}t}\right)\nonumber\\
  &=E\left(e^{Xt}e^{-\frac{n+1}{2}t}\right)\nonumber\\
  &=e^{-\frac{n+1}{2}t}E\left(e^{Xt}\right)\nonumber\\
  &=e^{-\frac{n+1}{2}t}\sum_{x=1}^1p\left(x\right)e^{xt}\nonumber\\
  &=e^{-\frac{n+1}{2}t}\sum_{x=1}^1\frac{1}{n}e^{xt}\nonumber\\
  &=\frac{1}{n}e^{-\frac{n+1}{2}t}\sum_{x=1}^1e^{xt}\nonumber\\
 \end{align}
 \subsection{歪度}
 \subsection{尖度}
 \subsection{エントロピー}
