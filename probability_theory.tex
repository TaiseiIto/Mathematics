...
さらに$J$を選ぶ場合の数も考慮すると，
 \begin{align}
  B_{|S|,k}\left(f\left(1\right),\cdots,f\left(|I|\right)\right)=\sum_{J\in J_k}|S|!\prod_{i\in I}\frac{1}{|J\left(i\right)|!}\left(\frac{f\left(i\right)}{\left(i!\right)}\right)^{|J\left(i\right)|}
 \end{align}
