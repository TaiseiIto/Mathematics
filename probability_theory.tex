...
と定義される．
 ...
 \begin{align}
  ...
  &=\sum_{k=n}^\infty \frac{E\left(X^k\right)}{k!}\frac{k!}{\left(k-n\right)!}t^{k-n}\nonumber\\
  &=\sum_{k=n}^\infty \frac{E\left(X^k\right)}{\left(k-n\right)!}t^{k-n}\nonumber\\
  &=\sum_{k=0}^\infty \frac{E\left(X^{k+n}\right)}{k!}t^k\nonumber\\
  M_X^{\left(n\right)}\left(0\right)&=\frac{E\left(X^{0+n}\right)}{0!}t^0\nonumber\\
  &=\frac{E\left(X^n\right)}{0!}t^0\nonumber\\
  &=E\left(X^n\right)\nonumber\\
 \end{align}
\end{document}
