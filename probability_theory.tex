...
キュムラントの定義\ref{CumulantGeneratingFunction}より，
 ...
 \end{align}
両辺の係数を比較する．
左辺の$t^0$の項は$n=0$の項であり，右辺の$t^0$の項も$n=0$の項であるから，
 \begin{align}
  \left.\frac{M_X^{\left(n\right)}\left(0\right)t^n}{n!}\right|_{n=0}&=\left.\frac{1}{n!}\left(\sum_{m=0}^\infty\frac{K_X^{\left(m\right)}\left(0\right)t^m}{m!}\right)^n\right|_{n=0}\nonumber\\
  M_X\left(0\right)&=1
 \end{align}
左辺の$t^1$の項は$n=1$の項であり，右辺の$t^0$の項は$n=1,m=1$の項であるから，
 \begin{align}
  \left.\frac{M_X^{\left(n\right)}\left(0\right)t^n}{n!}\right|_{n=1}&=\left.\frac{1}{n!}\left(\frac{K_X^{\left(m\right)}\left(0\right)t^m}{m!}\right)^n\right|_{n=1\land m=1}\nonumber\\
  M_X^{\left(1\right)}\left(0\right)t&=K_X^{\left(1\right)}\left(0\right)t\nonumber\\
  M_X^{\left(1\right)}\left(0\right)&=K_X^{\left(1\right)}\left(0\right)
 \end{align}
