 ...
 \section{標準正規分布}
  \subsection{ポアソン分布から標準正規分布を導出}
   ...
   \subsubsection{上界，下界の定義}
    上界$S<u$の定義は以下の通りである．
    \begin{align}
     \forall \left(R, u\right)\in 2^\mathbb{R}\times\mathbb{R},R<u\iff\forall r\in R,r<u
    \end{align}
    下界$l<S$の定義は以下の通りである．
    \begin{align}
     \forall \left(R, l\right)\in 2^\mathbb{R}\times\mathbb{R},l<R\iff\forall r\in R,l<r
    \end{align}
   \subsubsection{上限，下限の定義}
    ...
    \end{align}
    とする．
    $\forall R\in 2^\mathbb{R}$の上限$\sup R$は以下を満たす．
    \begin{align}
     \forall R\in 2^\mathbb{R},R<\sup R\land\forall\epsilon\in{}_{0<}\mathbb{R},R\cap\left[\sup R-\epsilon,\sup R\right]\ne\emptyset
    \end{align}
    $\forall R\in 2^\mathbb{R}$の下限$\inf R$は以下を満たす．
    \begin{align}
     \forall R\in 2^\mathbb{R},\inf R<R\land\forall\epsilon\in{}_{0<}\mathbb{R},R\cap\left[\inf R,\inf R+\epsilon\right]\ne\emptyset
    \end{align}
   \subsubsection{実数の連続性}
    上界$u$を持つ$R\subset\mathbb{R}$は，必ず上限$\sup R$を持つことを証明する．
