...
\begin{document}
 ...
 \section{微分}
  ...
  \subsection{全微分}
   ...
   \end{align}
   と書く．
   \subsubsection{連続領域は開区間である}
   \subsubsection{開区間上の連続領域は幅を持つ}
    \begin{align}
     &\forall\left(f,x\right)\in\mathbb{R}^{\left(x_{\inf{}},x_{\sup{}}\right)}\times\left(x_{\inf{}},x_{\sup{}}\right),\lim_{h\to0}f\left(x+h\right)=f\left(x\right)\nonumber\\
     \implies&\exists\left(c_{\inf{}},c_{\sup{}}\right)\in\left(x_{\inf{}},x\right)\times\left(x,x_{\sup{}}\right),\forall c\in\left(c_{\inf{}},c_{\sup{}}\right),\lim_{h\to0}f\left(c+h\right)=f\left(c\right)
    \end{align}
    を証明する．
    開区間上の連続領域が幅を持たない場合，その連続領域は閉区間$\{x\}$であり，連続領域が開区間であることに矛盾する．
    よって開区間上の連続領域は幅を持つ．
   ...
   \subsubsection{偏導関数が連続ならば全微分可能}
    \begin{align}
     ...
     &\forall n\in\mathbb{N}_{\le N},\exists\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)\land\exists m\in\mathbb{N}_{\le N},\lim_{h_m\to 0}\pdv{f}{x_m}\left(a_1,\cdots,a_{m-1},a_m+h_m,a_{m+1},\cdots,a_N\right)=\pdv{f}{x_m}\left(a_1,\cdots,a_N\right)\nonumber\\
     &\implies\forall n\in\mathbb{N}_{\le N},\exists\dv{f}{x_n}\left(a_1,\cdots,a_N\right)
    \end{align}
    を証明する．
    関数の引数の順序を入れ替えることを考えると，一般性を失わずに
    \begin{align}
     \exists m\in\mathbb{N}_{\le N},\lim_{h_m\to 0}\pdv{f}{x_m}\left(a_1,\cdots,a_{m-1},a_m+h_m,a_{m+1},\cdots,a_N\right)=\pdv{f}{x_m}\left(a_1,\cdots,a_N\right)
    \end{align}
    を
    \begin{align}
     \lim_{h_1\to 0}\pdv{f}{x_1}\left(a_1+h_1,a_2,\cdots,a_N\right)=f\left(a_1,\cdots,a_N\right)
    \end{align}
    と言い換えられる．
    また，
    \begin{align}
    ...
    \end{align}
    より，$f$は$\left(a_1,\cdots,a_N\right)$において各引数上連続であり，開区間上の連続領域は幅を持つから，関数
    \begin{align}
    ...
    平均値の定理より，
    \begin{align}
     &\exists\epsilon_0\left(h_1,\cdots,h_N\right)\in\left(0,h_1\right),\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)=\frac{f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)}{h_1}\nonumber\\
     &h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)=f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     &h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)=f\left(a_1+h_1,\cdots,a_N+h_N\right)
    \end{align}
    よって，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)
    \end{align}
    さらに，
    \begin{align}
     \epsilon_1\left(h_1,\cdots,h_N\right)&=\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     \epsilon_1\left(h_1,\cdots,h_N\right)+\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)&=\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)
    \end{align}
    とすると，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),a_2+h_2,\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\left(\epsilon_1\left(h_1,\cdots,h_N\right)+\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)
    \end{align}
    さらに，
    \begin{align}
     \epsilon_2\left(h_2,\cdots,h_N\right)&=\frac{f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)}{h_2}-\pdv{f}{x_2}\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)
    \end{align}
    とすると，
    \begin{align}
     \epsilon_2\left(h_2,\cdots,h_N\right)+\pdv{f}{x_2}\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)&=\frac{f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)}{h_2}\nonumber\\
     h_2\epsilon_2\left(h_2,\cdots,h_N\right)+h_2\pdv{f}{x_2}\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)&=f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)\nonumber\\
     h_2\epsilon_2\left(h_2,\cdots,h_N\right)+h_2\pdv{f}{x_2}\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)+f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)&=f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)
    \end{align}
    だから，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)=&h_1\epsilon_1\left(h_1,\cdots,h_N\right)+h_1\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     &+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     =&h_1\left(\epsilon_1\left(h_1,\cdots,h_N\right)+\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\right)\nonumber\\
     &+h_2\left(\epsilon_2\left(h_2,\cdots,h_N\right)+\pdv{f}{x_2}\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)\right)\nonumber\\
     &+f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)
    \end{align}
    である．
    一般に，
    \begin{align}
     \forall n\in{}_{2\le}\mathbb{N}_{\le N},\epsilon_n\left(h_n,\cdots,h_N\right)=&\frac{f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)}{h_n}\nonumber\\
     &-\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)
    \end{align}
    とすると，
    \begin{align}
     &\epsilon_n\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)=\frac{f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)}{h_n}\nonumber\\
     &h_n\left(\epsilon_n\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\right)=f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
    \end{align}
    だから，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)=\sum_{n=1}^Nh_n\left(\epsilon\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\right)
    \end{align}
    である．
    ここで，
    \begin{align}
     h=\left|\left(h_1,\cdots,h_N\right)\right|=\sqrt{\sum_{n=1}^Nh_n^2}
    \end{align}
    とし，
    \begin{align}
     \forall n\in{}_{0\le}\mathbb{Z}_{\le N}\lim_{h\to0}\epsilon_n
    \end{align}
    を考えてみよう．
    \begin{align}
     &\epsilon_0\left(h_1,\cdots,h_N\right)\in\left(0,h_1\right)\nonumber\\
     \implies&\lim_{h\to0}\epsilon_0\left(h_1,\cdots,h_N\right)=0\nonumber\\
    \end{align}
    である．
    また，
    \begin{align}
    ...
    より，
    \begin{align}
     \lim_{h\to0}\epsilon_1\left(h_1,\cdots,h_N\right)&=\lim_{h\to0}\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     &=\lim_{h\to0}\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     &=0
    \end{align}
    である．
    また，
    \begin{align}
     \forall n\in{}_{2\le}\mathbb{N}_{\le N},\lim_{h\to0}\epsilon_n\left(h_n,\cdots,h_N\right)=&\lim_{h\to0}\frac{f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)}{h_n}\nonumber\\
     &-\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     =&\lim_{h\to0}\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     &-\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     =&0
    \end{align}
    である．
    よって，
    \begin{align}
     \lim_{h\to0}\Delta f\left(h_1,\cdots,h_N\right)=&\lim_{h\to0}\sum_{n=1}^Nh_n\left(\epsilon\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\right)\nonumber\\
     \lim_{h\to0}f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)=&\lim_{h\to0}\sum_{n=1}^Nh_n\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     \lim_{h\to0}\frac{f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)}{h}=&\lim_{h\to0}\frac{1}{h}\sum_{n=1}^Nh_n\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     \lim_{h\to0}\left(\sum_{n=1}^Nh_n^2\right)^{-\frac{1}{2}}\left(f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\right)=&\lim_{h\to0}\left(\sum_{n=1}^Nh_n^2\right)^{-\frac{1}{2}}\sum_{n=1}^Nh_n\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)
    \end{align}
    ここで，
    \begin{align}
     \forall n\in\mathbb{N}_{\le N},g_n=\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)
    \end{align}
    とすれば，全微分可能性の定義を満たしていることがわかる．
  \subsection{複素微分}
