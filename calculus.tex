 ...
 \section{微分}
  ...
  \subsection{$\sin$の微分}
   ...
   \subsubsection{加法定理}
    ...
    \begin{align}
     \left|\vec{OA}\right|^2+\left|\vec{OB}\right|^2-\left|\vec{AB}\right|^2&=2\left|\vec{OA}\right|\left|\vec{OB}\right|\cos\angle AOB\nonumber\\
     1+1-\left(\left(\cos\alpha-\cos\beta\right)^2+\left(\sin\alpha-\sin\beta\right)^2\right)&=2\cos\left(\alpha-\beta\right)\nonumber\\
     2-\left(\cos^2\alpha-2\cos\alpha\cos\beta+\cos^2\beta+\sin^2\alpha-2\sin\alpha\sin\beta+\sin^2\beta\right)&=2\cos\left(\alpha-\beta\right)\nonumber\\
     2-\left(\left(\sin^2\alpha+\cos^2\alpha\right)+\left(\sin^2\beta+\cos^2\beta\right)-2\cos\alpha\cos\beta-2\sin\alpha\sin\beta\right)&=2\cos\left(\alpha-\beta\right)\nonumber\\
     2-\left(1+1-2\cos\alpha\cos\beta-2\sin\alpha\sin\beta\right)&=2\cos\left(\alpha-\beta\right)\nonumber\\
     2-\left(2-2\cos\alpha\cos\beta-2\sin\alpha\sin\beta\right)&=2\cos\left(\alpha-\beta\right)\nonumber\\
     2-2+2\cos\alpha\cos\beta+2\sin\alpha\sin\beta&=2\cos\left(\alpha-\beta\right)\nonumber\\
     2\cos\alpha\cos\beta+2\sin\alpha\sin\beta&=2\cos\left(\alpha-\beta\right)\nonumber\\
     \cos\alpha\cos\beta+\sin\alpha\sin\beta&=\cos\left(\alpha-\beta\right)
    \end{align}
    $\beta$を$-\beta$に変えると，
    \begin{align}
     \cos\alpha\cos\left(-\beta\right)+\sin\alpha\sin\left(-\beta\right)&=\cos\left(\alpha-\left(-\beta\right)\right)\nonumber\\
     \cos\alpha\cos\beta-\sin\alpha\sin\beta&=\cos\left(\alpha+\beta\right)\nonumber\\
    \end{align}
