  ...
  \subsection{全微分}
   ...
   \subsubsection{偏導関数が連続ならば全微分可能}
    \begin{align}
     ...
     &\forall n\in\mathbb{N}_{\le N},\exists\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)\land\exists m\in\mathbb{N}_{\le N},\lim_{h\to 0}f\left(a_1,\cdots,a_{m-1},a_m+h,a_{m+1},\cdots,a_N\right)=f\left(a_1,\cdots,a_N\right)\nonumber\\
