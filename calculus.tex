...
\begin{document}
 ...
 \section{微分}
  ...
  \subsection{全微分}
   ...
   \subsubsection{ロルの定理}
    \begin{align}
     \forall f\in C^0\left(\mathbb{R}^{\left[a,b\right]}\right),f\left(a\right)=f\left(b\right)\land\forall x\in\left(a,b\right),\exists\dv{f\left(x\right)}{x}\implies\exists c\in\left(a,b\right),\dv{f}{x}\left(c\right)=0
    \end{align}
    を証明する．
    最大値最小値の定理より，
    \begin{align}
