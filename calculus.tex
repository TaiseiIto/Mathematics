...
\begin{document}
 ...
 \section{微分}
  ...
  \subsection{商の微分}
   ...
   \end{align}
  \subsection{偏微分}
   $f:\mathbb{R}^n\to\mathbb{R}$の，$m$番目の引数における偏微分を，
   \begin{align}
    \pdv{f}{x_m}\left(x_1,\cdots,x_m,\cdots,x_n\right)=\lim_{h\to 0}\frac{f\left(x_1,\cdots,x_m+h,\cdots,x_n\right)-f\left(x_1,\cdots,x_m,\cdots,x_n\right)}{h}
   \end{align}
   と定義する．
  \subsection{全微分}
  \subsection{複素微分}
