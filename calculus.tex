 ...
 \section{微分}
  ...
  \subsection{全微分}
   ...
   \subsubsection{偏導関数が連続ならば全微分可能}
    ...
    さらに，
    \begin{align}
     \epsilon_1&=\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)\nonumber\\
     \epsilon_1+\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)&=\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)
    \end{align}
    とすると，
    \begin{align}
     ...
     &=h_1\left(\epsilon_1+\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\epsilon_1+h_1\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)
    \end{align}
    さらに，
    \begin{align}
     &\forall n\in{}_{2\le}\mathbb{N}_{\le N},\epsilon_n\left(h_n,\cdots,h_N\right)=f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     &\iff\epsilon_n\left(h_n,\cdots,h_N\right)+f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)=f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)
    \end{align}
    とすると，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+\sum_{n=2}^N\epsilon_n
    \end{align}
  \subsection{複素微分}
