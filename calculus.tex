 ...
 \section{微分}
  ...
  \subsection{全微分}
   ...
   \subsubsection{偏導関数が連続ならば全微分可能}
    ...
    平均値の定理より，
    \begin{align}
     &\exists\epsilon_1\left(h_1,\cdots,h_N\right)\in\left(0,h_1\right),\pdv{f}{x_1}\left(a_1+\epsilon_1\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)=\frac{f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)}{h_1}\nonumber\\
     &h_1\pdv{f}{x_1}\left(a_1+\epsilon_1\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)=f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     &h_1\pdv{f}{x_1}\left(a_1+\epsilon_1\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)=f\left(a_1+h_1,\cdots,a_N+h_N\right)
    \end{align}
    よって，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\pdv{f}{x_1}\left(a_1+\epsilon_1\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
    \end{align}
    さらに，
    \begin{align}
    ...
    とすると，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=h_1\pdv{f}{x_1}\left(a_1+\epsilon_1\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\pdv{f}{x_1}\left(a_1+\epsilon_1\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+\sum_{n=2}^N\epsilon_n
    \end{align}
  \subsection{複素微分}
