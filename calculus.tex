  ...
  \subsection{スターリングの公式の証明に使われる不等式}
   ...
   \subsubsection{上界の証明}
    \begin{align}
     ...
     &=-\frac{8x^4+16x^3+8x^2-\left(32x^4+48x^3+16x^2+16x^3+24x^2+8x\right)}{16x^4\left(x+1\right)^4}\nonumber\\
     &=-\frac{8x^4+16x^3+8x^2-\left(32x^4+64x^3+40x^2+8x\right)}{16x^4\left(x+1\right)^4}\nonumber\\
     &=-\frac{8x^4+16x^3+8x^2-32x^4-64x^3-40x^2-8x}{16x^4\left(x+1\right)^4}\nonumber\\
     &=\frac{32x^4+64x^3+40x^2+8x-8x^4-16x^3-8x^2}{16x^4\left(x+1\right)^4}\nonumber\\
     &=\frac{24x^4+48x^3+32x^2+8x}{16x^4\left(x+1\right)^4}\nonumber\\
     &=\frac{3x^3+6x^2+4x+1}{2x^3\left(x+1\right)^4}\nonumber\\
