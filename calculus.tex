 ...
 \section{スターリングの公式}
  ...
  \subsection{優級数定理}
   ...
   \subsubsection{証明}
    収束する列は基本列だから，
    \begin{align}
     &\forall\left(x,n_1,n_2\right)\in I\times\mathbb{N}^2,\sum_{n=n_1}^{n_2}\left|f\left(n,x\right)\right|\le\sum_{n=n_1}^{n_2} s\left(n\right)\in\mathbb{R}\nonumber\\
     &\implies\forall\left(x,n_1,n_2\right)\in I\times\mathbb{N}^2,\sum_{n=n_1}^{n_2}\left|f\left(n,x\right)\right|\le\sum_{n=n_1}^{n_2} s\left(n\right)\in\mathbb{R}\nonumber\\
     &\implies\forall x\in I,\lim_{n1,n2\to\infty}\sum_{n=n_1}^{n_2}\left|f\left(n,x\right)\right|\le\sum_{n=n_1}^{n_2} s\left(n\right)=0\nonumber\\
     &\implies\forall x\in I,\lim_{n1,n2\to\infty}\sum_{n=n_1}^{n_2}\left|f\left(n,x\right)\right|=0\nonumber\\
     &\implies\forall x\in I,\lim_{n1,n2\to\infty}\left|g\left(n_2,x\right)\right|-\left|g\left(n_1-1,x\right)\right|=0\nonumber\\
     &\implies\forall x\in I,\lim_{n1,n2\to\infty}\left|g\left(n_2,x\right)\right|-\left|g\left(n_1,x\right)\right|=0\nonumber\\
     &\implies\forall x\in I,\lim_{n1,n2\to\infty}\left|g\left(n_2,x\right)-g\left(n_1,x\right)\right|=0
    \end{align}
    よって$g$は$x\in I$に渡って一様に基本列であり，よって一様収束する．
  \subsection{複素積分の導入}
