 ...
 \section{微分}
  ...
  \subsection{全微分}
   ...
   \subsubsection{偏導関数が連続ならば全微分可能}
    ...
    平均値の定理より，
    \begin{align}
     &\exists\epsilon_0\left(h_1,\cdots,h_N\right)\in\left(0,h_1\right),\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)=\frac{f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)}{h_1}\nonumber\\
     &h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)=f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)\nonumber\\
     &h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)=f\left(a_1+h_1,\cdots,a_N+h_N\right)
    \end{align}
    よって，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=f\left(a_1+h_1,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)
    \end{align}
    さらに，
    \begin{align}
     \epsilon_1\left(h_1,\cdots,h_N\right)&=\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)\nonumber\\
     \epsilon_1\left(h_1,\cdots,h_N\right)+\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)&=\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)
    \end{align}
    とすると，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)&=h_1\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\left(\epsilon_1\left(h_1,\cdots,h_N\right)+\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     &=h_1\epsilon_1\left(h_1,\cdots,h_N\right)+h_1\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)
    \end{align}
    さらに，
    \begin{align}
     \epsilon_2\left(h_2,\cdots,h_N\right)&=\frac{f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)}{h_2}-\pdv{f}{x_2}\left(a_1,\cdots,a_N\right)
    \end{align}
    とすると，
    \begin{align}
     \epsilon_2\left(h_2,\cdots,h_N\right)+\pdv{f}{x_2}\left(a_1,\cdots,a_N\right)&=\frac{f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)}{h_2}\nonumber\\
     h_2\epsilon_2\left(h_2,\cdots,h_N\right)+h_2\pdv{f}{x_2}\left(a_1,\cdots,a_N\right)&=f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)\nonumber\\
     h_2\epsilon_2\left(h_2,\cdots,h_N\right)+h_2\pdv{f}{x_2}\left(a_1,\cdots,a_N\right)+f\left(a_1,a_2,a_3+h_3,\cdots,a_N+h_N\right)&=f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)
    \end{align}
    だから，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)=&h_1\epsilon_1\left(h_1,\cdots,h_N\right)+h_1\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)+f\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_N\right)\nonumber\\
     =&h_1\epsilon_1\left(h_1,\cdots,h_N\right)+h_1\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)\nonumber\\
     &+h_2\epsilon_2\left(h_2,\cdots,h_N\right)+h_2\pdv{f}{x_2}\left(a_1,\cdots,a_N\right)\nonumber\\
    ...
    \begin{align}
     ...
     &-\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)
    \end{align}
    とすると，
    \begin{align}
     &\epsilon_n\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)=\frac{f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)}{h_n}\nonumber\\
     &\epsilon_n\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)=\frac{f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)}{h_n}\nonumber\\
     &h_n\epsilon_n\left(h_n,\cdots,h_N\right)+h_n\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)=f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)-f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)\nonumber\\
     &h_n\epsilon_n\left(h_n,\cdots,h_N\right)+h_n\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)+f\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)=f\left(a_1,\cdots,a_{n-1},a_n+h_n,\cdots,a_N+h_N\right)
    \end{align}
    だから，
    \begin{align}
     \Delta f\left(h_1,\cdots,h_N\right)=\sum_{n=1}^Nh_n\left(\epsilon\left(h_n,\cdots,h_N\right)+\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)\right)
    \end{align}
    である．
    ここで，
    \begin{align}
    ...
    より，
    \begin{align}
     \lim_{h\to0}\epsilon_1\left(h_1,\cdots,h_N\right)&=\lim_{h\to0}\pdv{f}{x_1}\left(a_1+\epsilon_0\left(h_1,\cdots,h_N\right),\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)\nonumber\\
     &=\lim_{h\to0}\pdv{f}{x_1}\left(a_1,a_2+h_2,\cdots,a_N+h_N\right)-\pdv{f}{x_1}\left(a_1,\cdots,a_N\right)
    \end{align}
    である．
    また，
    \begin{align}
     ...
     &-\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)\nonumber\\
     =&\lim_{h\to0}\pdv{f}{x_n}\left(a_1,\cdots,a_n,a_{n+1}+h_{n+1},\cdots,a_N+h_N\right)-\pdv{f}{x_n}\left(a_1,\cdots,a_N\right)
    \end{align}
    である．
  \subsection{複素微分}
