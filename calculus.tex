 ...
 \section{微分}
  ...
  \subsection{指数関数の微分}
   ...
   \subsubsection{相加相乗平均の不等式}
    \begin{align}
     \forall\left(a,b\right)\in\mathbb{R}^2,&0\le\left(\sqrt{a}-\sqrt{b}\right)^2\nonumber\\
     \implies&0\le a+b-2\sqrt{ab}\nonumber\\
     \implies&2\sqrt{ab}\le a+b\nonumber\\
     \implies&\sqrt{ab}\le\frac{a+b}{2}
    \end{align}
  ...
  \subsection{累乗の微分}
   ...
   \subsubsection{負の整数乗の微分}
    ...
    \end{align}
    よって成り立つ．
   \subsubsection{非$0$有理数乗の微分}
    \begin{align}
     \forall\left(n,m\right)\in\mathbb{Z}_{\ne 0}^2,\dv{x^{\frac{m}{n}}}{x}&=\dv{e^{\frac{m}{n}\log x}}{x}\nonumber\\
     &=e^{\frac{m}{n}\log x}\dv{\frac{m}{n}\log x}{x}\nonumber\\
     &=\frac{m}{n}e^{\frac{m}{n}\log x}\dv{\log x}{x}\nonumber\\
     &=\frac{m}{n}e^{\frac{m}{n}\log x}x^{-1}\nonumber\\
     &=\frac{m}{n}e^{\frac{m}{n}\log x}e^{-\log x}\nonumber\\
     &=\frac{m}{n}e^{\left(\frac{m}{n}-1\right)\log x}\nonumber\\
